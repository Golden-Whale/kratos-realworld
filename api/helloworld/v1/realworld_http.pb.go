...
func RegisterRealWorldHTTPServer(s *http.Server, srv RealWorldHTTPServer) {
	...
	r.GET("/api/tags", _RealWorld_GetTag0_HTTP_Handler(srv))
}
...
func _RealWorld_FavoriteArticle0_HTTP_Handler(srv RealWorldHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.FavoriteArticle(ctx, req.(*FollowArticleRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
...
func _RealWorld_UnFavoriteArticle0_HTTP_Handler(srv RealWorldHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.UnFavoriteArticle(ctx, req.(*UnFollowArticleRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
...
func _RealWorld_GetTag0_HTTP_Handler(srv RealWorldHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in GetTagRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
		}
		http.SetOperation(ctx, "/realworld.v1.RealWorld/GetTag")
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
type RealWorldHTTPClient interface {
	...
	DeleteComments(ctx context.Context, req *DeleteCommentsRequest, opts ...http.CallOption) (rsp *SingleComment, err error)
	FavoriteArticle(ctx context.Context, req *FollowArticleRequest, opts ...http.CallOption) (rsp *ProfileReply, err error)
	...
	GetTag(ctx context.Context, req *GetTagRequest, opts ...http.CallOption) (rsp *TagListReply, err error)
	...
	UnFavoriteArticle(ctx context.Context, req *UnFollowArticleRequest, opts ...http.CallOption) (rsp *ProfileReply, err error)
...
func (c *RealWorldHTTPClientImpl) DeleteComments(ctx context.Context, in *DeleteCommentsRequest, opts ...http.CallOption) (*SingleComment, error) {
	var out SingleComment
...
func (c *RealWorldHTTPClientImpl) GetTag(ctx context.Context, in *GetTagRequest, opts ...http.CallOption) (*TagListReply, error) {
	var out TagListReply
	pattern := "/api/tags"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation("/realworld.v1.RealWorld/GetTag"))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *RealWorldHTTPClientImpl) UnFavoriteArticle(ctx context.Context, in *UnFollowArticleRequest, opts ...http.CallOption) (*ProfileReply, error) {
	var out ProfileReply
	pattern := "/api/articles/{slug}/favorite"
	path := binding.EncodeURL(pattern, in, true)
